      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-stone-900 mb-1">{ref.title}</h3>
              ...
              <p className="text-stone-700 leading-relaxed mb-4"><span className="font-semibold">Used in:</span> {ref.uses}</p>
              {ref.url && (
                <a
                  href={ref.url}
                  target="_blank"
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-8 border border-amber-200">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-stone-900 mb-2">Additional Resources</h3>
              <p className="text-stone-700 mb-4 leading-relaxed">
                For further research into the Bone Wars and paleontology, consider consulting university archives,
                museum collections (particularly at Yale's Peabody Museum and the Smithsonian Institution), and
                academic databases like JSTOR and Google Scholar.
              </p>
              <p className="text-stone-700">
                Many of Cope and Marsh's original publications are digitized and available through institutional
                repositories and Internet Archive.
              </p>
            </div>
          </div>
        </div>
